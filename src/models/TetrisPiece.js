...
const TetrisPiece = {
	...
	getTranslateOp: translation => piece => {
		return TetrisPiece.translate(piece, translation);
	},
	...
	rotate: (piece, clockwise) => {
		...
		piece._bounds = null;
		TetrisPiece.translate(piece, {rows: -bounds.top, cols: -bounds.left});
		...
		let rotBounds = TetrisPiece.getBounds(piece);
		TetrisPiece.translate(piece, {rows: bounds.top - rotBounds.top, cols: bounds.left - rotBounds.left});
	},

	getRotateOp: clockwise => piece => {
		return TetrisPiece.rotate(piece, clockwise);
	}
};
